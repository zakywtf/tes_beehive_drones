      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            return _context3.abrupt("return", _objectSpread(_objectSpread({}, udata), {}, {
              token: token
            }));
          case 18:
...
var deleteSession = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(udata) {
    var datas;
...
var checkSession = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(udata) {
    var sessionData;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            sessionData = SESSION["".concat(udata.id)]; // console.log({sessionData});
            if (!sessionData) {
              _context5.next = 5;
              break;
            }
