...
var sign = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(body, userAgent) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            tes = _bcryptjs["default"].compareSync(password + process.env.SALT, user.password);
            if (!_bcryptjs["default"].compareSync(password + process.env.SALT, user.password)) {
              _context.next = 18;
              break;
            }
            _context.next = 12;
