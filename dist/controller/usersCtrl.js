...
rtr.get('/pagination/:level/:page/:perPage', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            (0, _ctrlHandler["default"])(req, res, /*#__PURE__*/function () {
              var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(body) {
                var udata, _req$params, page, perPage, level, role;
                return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        udata = res.locals.udata.payload;
                        _req$params = req.params, page = _req$params.page, perPage = _req$params.perPage, level = _req$params.level;
                        if (!(udata.level > 5)) {
                          _context7.next = 9;
                          break;
                        }
                        role = level == "admin" ? 10 : 5;
                        _context7.next = 6;
