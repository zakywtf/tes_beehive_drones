...
var userModel = /*#__PURE__*/function (_Models) {
  ...
  _createClass(userModel, [{
    ...
    key: "insert",
    value: function () {
      var _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(obj) {
        var pass;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                pass = this.generateCode(6); // await this.sendMail(obj, pass)
                _context2.next = 5;
    ...
    key: "sendMail",
    value: function () {
      var _sendMail = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(body, pass) {
        var html, mail;
    ...
    value: function doConvertParam(body, pass) {
      ...
      body.password = _bcryptjs["default"].hashSync(body.password + body.email + process.env.SALT, 10);
      return body;
    }
  }, {
    key: "getProjection",
